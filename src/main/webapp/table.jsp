				...
				<div class="card">
					...
					<div class="card-header">
						...
						<div class="alert alert-warning alert-dismissible fade show"
							role="alert">
							<strong>Hey!!</strong> Table Successfully Added
						...
						<div class="alert alert-warning alert-dismissible fade show"
							role="alert">
							<strong>Hey!!</strong> Table Successfully Edited
							<button type="button" class="close" data-dismiss="alert"
								aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						...
						<div class="alert alert-warning alert-dismissible fade show"
							role="alert">
							<strong>Hey!!</strong> Table Successfully Deleted
							<button type="button" class="close" data-dismiss="alert"
								aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
										...
										<tbody>
											<tr>
												...
												<td><a href="ManageTableCtrl?id=<%=rs.getInt(4)  %>"
													...
													<a href="deletetable.jsp?id=<%=rs.getInt(4) %>"
													class="delete" title="Delete"><i
														class="material-icons">&#xE5C9;</i></a> <input type="hidden"
													name="id" id="id" value="<%=rs.getInt(4)%>"></td>
											</tr>
											<%} %>
										</tbody>
									</table>
