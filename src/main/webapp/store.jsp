...
<body>
				...
				<div class="card">
					...
					<div class="card-header">
						...
						<div class="alert alert-warning alert-dismissible fade show"
							role="alert">
							<strong>Hey!!</strong> Store Successfully Added
						...
						<div class="alert alert-warning alert-dismissible fade show"
							role="alert">
							<strong>Hey!!</strong> Store Successfully Edited
							<button type="button" class="close" data-dismiss="alert"
								aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						...
						<%} %>
						<%if(request.getAttribute("deletestore")!= null) {%>

						<div class="alert alert-warning alert-dismissible fade show"
							role="alert">
							<strong>Hey!!</strong> Store Successfully Deleted
							<button type="button" class="close" data-dismiss="alert"
								aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
  ...
  Add Stores
            ...
            ResultSet rs=st.executeQuery("SELECT * FROM R_STORE");
            while(rs.next())
            {%>
										<tbody>
											<tr>
												...
												<%} %>
												<td><a href="ManageStoreCtrl?id=<%=rs.getInt(1)  %>"
													class="edit" onclick="init()"><i
														class="material-icons">&#xE8B8;</i></a> <a
													href="deletestore.jsp?id=<%=rs.getInt(1) %>" class="delete"
													title="Delete"><i
											...
											<div class="cols-sm-10">
												<div class="input-group">
													...
													<input type="text" class="form-control" name="sname"
														id="name" placeholder="Enter Store Name" required /> <span
	...
	<%-- <jsp:useBean id="bean" class="com.restaurant.Bean.ManageStoreBean"
		scope="request"></jsp:useBean>
	<%
  
    		int id1=bean.getId();
    		  System.out.print("id name is "+id1);
    		
    		 String name=bean.getStore_name();
    		 String status=bean.isStatus();
    		  System.out.print("store name is "+name);
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a class="btn btn-primary" href="store.jsp">Delete</a>
				</div>
			</div>
		</div>
	</div>
...
function init()
{
 ...
 //   popupWin.document.writeln('<html><head><title>test</title></head><body><form><input type="text" id="exampleModal2"/></form></body></html>');
 //   popupWin.document.close();
   // popupText = popupWin.document.getElementById("#exampleModal2");
   // parentText = document.getElementById("parentTextBox");
   // transferText();
   // var i=popupText.value;
   // alert(i)
}
