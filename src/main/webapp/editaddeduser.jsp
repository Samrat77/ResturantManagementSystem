...
<body>
<jsp:useBean id="bean" class="com.restaurant.Bean.UserClass"
   ...
   <form action="UserCtrl" method="post">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													...
													<input type="text" class="form-control" name="uname"
														id="name" placeholder="Enter Table Name" value="<%=bean.getUsername() %>" required  disabled="disabled"/> <span
											...
											<div class="cols-sm-10">
												<div class="input-group">
													...
													<input type="text" class="form-control" name="emailid"
														id="name" placeholder="Enter Table Capacity" value="<%=bean.getEmailid() %>" required /> <span
														style="color: red; font-style: inherit;"><strong><%=(request.getAttribute("msg") == null) ? "" : request.getAttribute("msg")%></strong></span>
												</div>
											</div>
											<label for="name" class="cols-sm-2 control-label"><strong>
											...
											<div class="cols-sm-10">
												<div class="input-group">
													...
													<input type="text" class="form-control" name="phone"
														id="name" placeholder="Enter Table Capacity" value="<%=bean.getPhone() %>" required /> <span
														style="color: red; font-style: inherit;"><strong><%=(request.getAttribute("msg") == null) ? "" : request.getAttribute("msg")%></strong></span>
												</div>
											</div>
						...
						<div class="modal-footer">
							...
							<button type="submit" class="btn btn-primary" name="Action"
								value="EditUser">Update changes</button>
						</div>
					</form>
  </div>
</div>
