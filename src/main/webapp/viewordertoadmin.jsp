										...
										<table class="table table-striped table-hover">
											...
											<%
												...
												String sql = "select tname,pname,oid,quantity,rate,netamount,dateandtime,vat,ostatus from r_order inner join r_table on"
														+ " r_table.id=r_order.tableid" + " inner join r_product on r_product.id=r_order.productid;";
											...
											<tbody>
												<tr>
													...
													<td class="col-md-1"><i class="fas fa-rupee-sign"></i><%=rs.getString(6)%></td>
													<td class="col-md-1"><%=rs.getTimestamp(7).toGMTString()%></td>
													<td class="col-md-1"><strong><%=rs.getString(9).toUpperCase()%></strong></td>
